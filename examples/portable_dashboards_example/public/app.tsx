...
const PortableDashboardsDemos = ({
  ...
  return (
    <Router history={history}>
      <Routes>
        <Route path={DASHBOARD_LIST_PATH} element={<PortableDashboardListingDemo />} />
        <Route
          path={DASHBOARD_DEMO_PATH}
          element={<DashboardsDemo data={data} dashboard={dashboard} />}
        />
        <Route index path="/" element={<Navigate to={DASHBOARD_DEMO_PATH} replace />} />
      </Routes>
    </Router>
  );
};
  ...
  return (
    <KibanaPageTemplate>
      ...
      <KibanaPageTemplate.Section>
        <EuiButton onClick={() => navigate(DASHBOARD_LIST_PATH)}>
...
const PortableDashboardListingDemo = () => {
  ...
  return (
    ...
    >
      <EuiButton onClick={() => navigate(DASHBOARD_DEMO_PATH)}>Go back to usage demos</EuiButton>
      <EuiSpacer size="xl" />
