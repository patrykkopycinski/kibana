...
export declare const readVaultConfigFromFile: (repoRoot: string, profile?: string) => VaultConfig | undefined;
 ...
 */
export declare const loadVaultConfig: (repoRoot: string, profile?: string) => VaultConfig | undefined;
