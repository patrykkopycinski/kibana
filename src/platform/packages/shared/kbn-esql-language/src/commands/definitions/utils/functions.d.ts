...
export declare const filterFunctionDefinitions: (
...
export declare function printArguments(
  {
    name,
    type,
    optional,
 ...
 */
export declare function getFunctionSignatures(
...
export declare const buildColumnSuggestions: (
 ...
 */
export declare function getFunctionForInlineCast(
  castingType: InlineCastingType
): string | undefined;
