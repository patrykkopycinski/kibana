 ...
 */
export declare const ScoutTestConfigSchema: z.ZodPipe<z.ZodObject<{
    ...
    productTier: z.ZodOptional<z.ZodEnum<{
        complete: "complete";
    ...
    linkedProject: z.ZodOptional<z.ZodObject<{
        hosts: z.ZodObject<{
            elasticsearch: z.ZodURL;
        }, z.core.$strip>;
        auth: z.ZodObject<{
 ...
 */
export declare const parseScoutTestConfig: (input: unknown, source?: string) => z.infer<typeof ScoutTestConfigSchema>;
