...
export declare const resolveMoonAffectedBase: ({
  headRef,
 ...
 */
export declare const getAffectedMoonProjectsFromChangedFiles: ({
  changedFilesJson,
  downstream,
}: {
...
export declare const summarizeAffectedMoonProjects: (
