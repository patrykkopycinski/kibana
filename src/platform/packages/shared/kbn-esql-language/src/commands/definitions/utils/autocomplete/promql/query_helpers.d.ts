...
export declare function findNearestAggregation(
...
export declare function getBinaryNodeAtCursor(
...
export declare function findSelectorAfterBinaryInArgs(
  func: PromQLFunction,
  cursor: number
 ...
 */
export declare function computeParamIndexFromArgs(
  func: PromQLFunction,
  relativeCursor: number,
  text: string
): number;
/** Checks if cursor is at an argument boundary in a function. */
export declare function isAtFunctionArgStart(
  text: string,
  cursor: number,
  func: PromQLFunction
): boolean;
/** Resolves signature types by walking up to the enclosing function. */
export declare function getSignatureTypesFromAncestors(
  text: string,
  cursor: number,
