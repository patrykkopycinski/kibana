 ...
 */
type BaseSplitProps = Pick<SplitButtonWithNotificationProps, 'isMainButtonLoading' | 'isSecondaryButtonDisabled' | 'secondaryButtonAriaLabel' | 'iconType' | 'showNotificationIndicator' | 'notificationIndicatorTooltipContent'>;
 ...
 * Subset of SplitButtonWithNotificationProps.
 */
export type AppMenuSplitButtonProps = AppMenuSecondarySplitButton | AppMenuSecondarySplitButtonWithPopover;
/**
 ...
 */
export type AppMenuPopoverItem = Omit<AppMenuItemType, 'iconType' | 'hidden' | 'popoverWidth' | 'overflow'> & {
    /**
     * The icon type for the item.
     */
    iconType?: IconType;
 ...
 */
export type AppMenuPrimaryActionItem = AppMenuPrimaryActionButton | AppMenuPrimaryActionLink | AppMenuPrimaryActionPopover;
/**
