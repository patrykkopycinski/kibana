...
import type { ChromeSetup, ChromeStart, ChromeAppHeaderConfig, ChromeBadge, ChromeBreadcrumb, ChromeBreadcrumbsAppendExtension, ChromeBreadcrumbsBadge, ChromeNext, GlobalHeaderAiButton, ChromeUserBanner, GlobalSearchConfig, NavigationCustomization, NavigationTreeDefinition, NavigationTreeDefinitionUI, CloudURLs, SolutionId, ChromeProjectNavigationNode, ChromeSetProjectBreadcrumbsParams } from '@kbn/core-chrome-browser';
/** @internal */
...
export interface InternalChromeStart extends ChromeStart {
    ...
    project: {
        ...
        initNavigation<TTree extends NavigationTreeDefinition>(id: SolutionId, navigationTree$: Observable<TTree>): void;
