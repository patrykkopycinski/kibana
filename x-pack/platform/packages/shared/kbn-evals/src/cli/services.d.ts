 ...
 */
export declare const isScoutStale: (repoRoot: string, requestedConfigSet?: string, scoutEnv?: Record<string, string>) => {
    stale: boolean;
    reason?: string;
};
/**
 ...
 */
export declare const isEdotStale: (repoRoot: string, elasticsearchHost: string | undefined) => {
    stale: boolean;
    reason?: string;
};
/**
