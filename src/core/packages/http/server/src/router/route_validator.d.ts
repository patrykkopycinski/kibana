 ...
 * @public
 */
export type RequestValidationErrorHandler = (error: RequestValidationError, request: KibanaRequest, response: KibanaResponseFactory) => IKibanaResponse | Promise<IKibanaResponse>;
/**
