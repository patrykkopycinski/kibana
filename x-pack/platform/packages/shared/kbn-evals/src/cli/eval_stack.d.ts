 ...
 */
export declare const ensureEdot: ({ repoRoot, log, elasticsearchHost, }: EnsureEdotOptions) => Promise<void>;
 ...
 */
export declare const ensureScout: ({ repoRoot, log, gcsCredentials, tracingExporters, serverConfigSet, }: EnsureScoutOptions) => Promise<void>;
 ...
 */
export declare const ensureEvalStack: ({ repoRoot, log, profileEnvOverrides, serverConfigSet, requiresEisCcm, }: EnsureEvalStackOptions) => Promise<void>;
