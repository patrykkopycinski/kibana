...
export declare const evaluate: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions & {
    ...
    network: import("@kbn/scout/src/playwright/fixtures/scope/test/network/network").Network;
    page: import("@kbn/scout").ScoutPage;
} & {
    validateTags: void;
} & {
    perfTracker: import("@kbn/scout/src/playwright/fixtures/scope/test/performance/performance_tracker").PerformanceTracker;
}, import("playwright/test").PlaywrightWorkerArgs & import("playwright/test").PlaywrightWorkerOptions & import("@kbn/scout/src/playwright/fixtures/scope/worker/core_fixtures").BaseWorkerFixtures & {
    samlAuth: import("@kbn/scout").SamlAuth;
} & {
