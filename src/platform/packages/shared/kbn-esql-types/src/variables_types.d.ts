...
export declare const apiPublishesESQLVariable: (
  unknownApi: unknown
...
export declare const apiPublishesESQLVariables: (
  unknownApi: unknown
 ...
 */
export declare const controlHasVariableName: (
  controlState: unknown
) => controlState is HasVariableName;
export {};
