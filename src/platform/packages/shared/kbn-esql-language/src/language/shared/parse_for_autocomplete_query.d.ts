 ...
 */
export declare function parseAutocompleteQuery(
  fullText: string,
  offset: number
): ParsedAutocompleteQuery;
/**
...
export declare function getAutocompleteCursorContext(
  fullText: string,
  offset: number
): {
  innerText: string;
...
export declare function findAutocompleteAstPosition(
  fullText: string,
  offset: number
):
  | {
