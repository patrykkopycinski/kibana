 ...
 */
export declare const buildExperimentFilterQuery: (
  experimentId: string,
 ...
 */
export declare const buildExampleScoresQuery: (
  exampleId: string,
  options?: {
    spaceId?: string;
  }
 ...
 */
export declare const buildDatasetExampleScoresQuery: (
  datasetId: string,
  experimentId: string,
  options?: {
    filterField?: 'experiment_id' | 'metadata.execution_id';
 ...
 */
export declare const buildExperimentsListingFilterQuery: (
 ...
 * correct window.
 */
export declare const buildExperimentsListingAggregation: ({
  page,
  perPage,
 ...
 */
export declare const parseExperimentsListingResponse: (
 ...
 */
export declare const parseStatsAggregationResponse: (
  aggregations: Record<string, unknown> | undefined
 ...
 */
export declare const buildModelDisplayId: (
  id?: string,
  family?: string,
  provider?: string
) => string;
