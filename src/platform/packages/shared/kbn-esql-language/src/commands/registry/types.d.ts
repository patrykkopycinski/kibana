import type { ESQLVariableType, IndexAutocompleteItem, InferenceEndpointAutocompleteItem, ESQLControlVariable, ESQLSourceResult, ESQLFieldWithMetadata, ESQLCallbacks, EsqlView, EsqlDataset } from '@kbn/esql-types';
...
export type ItemKind = 'Method' | 'Function' | 'Field' | 'Variable' | 'Class' | 'Operator' | 'Value' | 'Constant' | 'Keyword' | 'Text' | 'Reference' | 'Snippet' | 'Issue' | 'Folder';
...
export type GetColumnsByTypeFn = (type: Readonly<string> | Readonly<string[]>, ignored?: string[], options?: {
...
export declare enum UnmappedFieldsStrategy {
    DEFAULT = "DEFAULT",
    NULLIFY = "NULLIFY",
    LOAD = "LOAD",
    LOAD_ALL = "LOAD_ALL"
}
export declare function isUnmappedFieldsStrategy(value: string | undefined): value is UnmappedFieldsStrategy;
