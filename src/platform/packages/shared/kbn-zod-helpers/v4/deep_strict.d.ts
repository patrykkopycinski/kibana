 ...
 */
export declare function DeepStrict<TSchema extends z.ZodType>(schema: TSchema): z.ZodPipe<z.ZodType<z.input<TSchema>, unknown, z.core.$ZodTypeInternals<z.input<TSchema>, unknown>>, z.ZodType<z.TypeOf<TSchema>, z.input<TSchema>, z.core.$ZodTypeInternals<z.TypeOf<TSchema>, z.input<TSchema>>>>;
