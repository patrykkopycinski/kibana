 ...
 */
export declare function isContextLengthExceededError(
  error: Error
): error is ChatCompletionContextLengthExceededError;
/**
 * Check if an error is a {@link ChatCompletionToolValidationError}
 */
export declare function isToolValidationError(
  error?: Error
): error is ChatCompletionToolValidationError;
/**
 * Check if an error is a {@link ChatCompletionTokenLimitReachedError}
 */
export declare function isOutputTokenLimitReachedError(
  error: Error
