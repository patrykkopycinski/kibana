...
export declare function findCommandOptionByName(
  command: ESQLCommand,
  name: FuseOption
 ...
 */
export declare function immediatelyAfterOptionField(
  innerText: string,
 ...
 */
export declare function immediatelyAfterOptionFieldsList(
  innerText: string,
  optionName: FuseOption
): boolean;
export declare function buildMissingMetadataMessage(
