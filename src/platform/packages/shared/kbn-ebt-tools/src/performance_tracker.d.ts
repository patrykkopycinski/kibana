 ...
 */
export declare const findMarkerByNamePostfix: (
 ...
 */
export declare const getPerformanceTrackersByType: (
  type: PerformanceTrackerTypes
) => PerformanceMark[];
/**
 ...
 */
export declare const getPerformanceTrackersGroupedById: (
  type: PerformanceTrackerTypes
) => import('lodash').Dictionary<PerformanceMark[]>;
/**
 ...
 */
export declare const getMeanFromPerformanceMeasures: ({
  type,
  startMark,
  endMark,
  createPerformanceMeasures,
}: GetMeanFromMeasuresOptions) => number;
export {};
