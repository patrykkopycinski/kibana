...
import type { RouteConfig, RouteMethod, RequestHandler, IKibanaResponse, RouteConfigOptions, RouteValidatorFullConfigRequest, RequestHandlerContextBase, RouteValidationFunction, LazyValidator, RouteSecurity } from '../..';
 ...
 * @public
 */
export type VersionedRouteConfig<Method extends RouteMethod> = Omit<RouteConfig<unknown, unknown, unknown, Method>, 'validate' | 'options'> & {
    options?: Pick<RouteConfigOptions<Method>, 'xsrfRequired' | 'tags' | 'body' | 'timeout' | 'excludeFromOAS' | 'excludeFromRateLimiter' | 'httpResource' | 'availability'>;
 ...
 * @public
 */
export type VersionedRouteRegistrar<Method extends RouteMethod, Ctx extends RqCtx = RqCtx> = (config: VersionedRouteConfig<Method>) => VersionedRoute<Method, Ctx>;
/**
...
/** @public */
export type VersionedResponseBodyValidation = LazyValidator | VersionedRouteCustomResponseBodyValidation;
/**
 ...
 * @public
 */
export interface VersionedRoute<Method extends RouteMethod = RouteMethod, Ctx extends RqCtx = RqCtx> {
    /**
