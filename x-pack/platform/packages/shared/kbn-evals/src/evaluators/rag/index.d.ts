...
export declare function createPrecisionAtKEvaluator<TOutput = unknown, TReferenceOutput = unknown>(
  config: RagEvaluatorConfig<TOutput, TReferenceOutput>
): Evaluator;
export declare function createRecallAtKEvaluator<TOutput = unknown, TReferenceOutput = unknown>(
  config: RagEvaluatorConfig<TOutput, TReferenceOutput>
): Evaluator;
export declare function createF1AtKEvaluator<TOutput = unknown, TReferenceOutput = unknown>(
  config: RagEvaluatorConfig<TOutput, TReferenceOutput>
): Evaluator;
/**
 ...
 */
export declare function createRagEvaluators<TOutput = unknown, TReferenceOutput = unknown>(
  config: RagEvaluatorConfig<TOutput, TReferenceOutput>
): Evaluator[];
