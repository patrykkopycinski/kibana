 ...
 */
export declare function isChatCompletionChunkEvent(
 ...
 */
export declare function isChatCompletionMessageEvent<T extends ToolOptions>(
  event: ChatCompletionEvent<T>
): event is ChatCompletionMessageEvent<T>;
/**
 * Check if the provided {@link ChatCompletionEvent} is a {@link ChatCompletionMessageEvent}
 */
export declare function isChatCompletionTokenCountEvent(
  event: ChatCompletionEvent
): event is ChatCompletionTokenCountEvent;
/**
 * Check if the provided {@link InferenceTaskEvent} is a {@link ChatCompletionEvent}
 */
export declare function isChatCompletionEvent(
  event: InferenceTaskEvent
): event is ChatCompletionEvent;
/**
 * Operator filtering out the chunk events from the provided observable.
 */
export declare function withoutChunkEvents<T extends ChatCompletionEvent>(): OperatorFunction<
  T,
 ...
 */
export declare function withoutTokenCountEvents<T extends ChatCompletionEvent>(): OperatorFunction<
  T,
