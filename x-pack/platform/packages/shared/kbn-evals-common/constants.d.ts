...
export declare const EVALS_DATASET_RESOLVE_URL: '/internal/evals/datasets/_resolve';
...
export declare const MAX_TAGS_PER_DATASET: 20;
export declare const MAX_TAG_LENGTH: 64;
export declare const MAX_DATASET_NAME_LENGTH: 256;
export declare const MAX_DATASET_DESCRIPTION_LENGTH: 2048;
export declare const MAX_DATASET_TAG_FACETS: 100;
