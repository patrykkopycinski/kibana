...
export declare const buildSourcesDefinitions: (
  sources: Array<{
    name: string;
 ...
 */
export declare const buildViewsDefinitions: (
  views: EsqlView[],
  alreadyUsed?: string[]
) => ISuggestionItem[];
/**
 ...
 */
export declare const buildDatasetsDefinitions: (
...
export declare function getSourcesFromCommands(
 ...
 */
export declare function hasWiredStreamsInQuery(
  query: string,
  callbacks?: Pick<ESQLCallbacks, 'getSources'>
): Promise<boolean>;
export declare function getSourceSuggestions(
...
export declare function additionalSourcesSuggestions(
  queryText: string,
  sources: ESQLSourceResult[],
  ignored: string[],
...
export declare const specialIndicesToSuggestions: (
