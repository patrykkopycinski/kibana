...
export declare const getPromqlUserDefinedColumn: (command: ESQLAstPromqlCommand) => ESQLIdentifier | undefined;
/** Collects the query expression, referenced metrics, and grouping labels. */
export declare const getPromqlOutputMetadata: (command: ESQLAstPromqlCommand) => PromqlOutputMetadata;
