...
import type { AppMenuConfig, AppMenuEbtAttrs, AppMenuItemCommon, AppMenuItemType, AppMenuPopoverItem, AppMenuPrimaryActionItem, AppMenuSwitch } from './types';
/**
 ...
 */
export declare const getLinkProps: <E extends Element = Element>({ href, onClick, }: {
    href?: string;
