...
export declare const spaceTest: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions & {
    context: import("playwright-core").BrowserContext;
} & {
    browserAuth: import("./single_thread_fixtures").BrowserAuthFixture;
} & {
...
export declare const globalSetupHook: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions, import("playwright/test").PlaywrightWorkerArgs & import("playwright/test").PlaywrightWorkerOptions & import("../../fixtures/scope/worker/core_fixtures").BaseWorkerFixtures & {
    samlAuth: import("../..").SamlAuth;
} & {
    esArchiver: import("../..").EsArchiverFixture;
} & {
...
export declare const globalTeardownHook: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions, import("playwright/test").PlaywrightWorkerArgs & import("playwright/test").PlaywrightWorkerOptions & import("../../fixtures/scope/worker/core_fixtures").BaseWorkerFixtures & {
    samlAuth: import("../..").SamlAuth;
} & {
    apiServices: import("./single_thread_fixtures").ApiServicesFixture;
}>;
export type { ScoutTestFixtures, ScoutWorkerFixtures } from './single_thread_fixtures';
export type { ScoutParallelTestFixtures, ScoutParallelWorkerFixtures, } from './parallel_run_fixtures';
