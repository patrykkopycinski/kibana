...
export declare class KbnClientSavedObjects {
     ...
     * Get an object
     */
    get<Attributes extends Record<string, any>>(options: GetOptions): Promise<SavedObjectResponse<Attributes>>;
    /**
     * Find saved objects
     */
    find<Attributes extends Record<string, any>>(options: FindOptions): Promise<SavedObjectsFindResponse<Attributes, unknown>>;
    private buildCreatePath;
    /**
     * Create a saved object
     */
    create<Attributes extends Record<string, any>>(options: IndexOptions<Attributes>): Promise<SavedObjectResponse<Attributes>>;
    /**
     * Update a saved object
     */
    update<Attributes extends Record<string, any>>(options: UpdateOptions<Attributes>): Promise<SavedObjectResponse<Attributes>>;
    /**
     * Delete an object
     */
    delete(options: GetOptions): Promise<unknown>;
    clean(options: CleanOptions): Promise<void>;
    cleanStandardList(options?: {
        space?: string;
    }): Promise<void>;
