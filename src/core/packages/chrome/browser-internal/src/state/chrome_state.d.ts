...
import type { ChromeBadge, ChromeBreadcrumb, ChromeBreadcrumbsAppendExtension, ChromeBreadcrumbsBadge, ChromeGlobalHelpExtensionMenuLink, ChromeHelpExtension, GlobalSearchConfig, ChromeNavLink, GlobalHeaderAiButton, ChromeUserBanner, ChromeAppHeaderConfig } from '@kbn/core-chrome-browser';
