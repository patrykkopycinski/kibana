...
export declare enum GenAISemanticConventions {
...
export declare enum ElasticGenAIAttributes {
...
export interface GenAISemConvAttributes {
    ...
    [GenAISemanticConventions.GenAIOperationName]?: 'chat' | 'execute_tool' | 'invoke_agent' | 'invoke_workflow';
