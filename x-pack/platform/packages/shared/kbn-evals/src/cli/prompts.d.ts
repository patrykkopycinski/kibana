...
export declare const parseConnectorsFromKibanaDevYml: (
  repoRoot: string
...
export declare const promptForSuite: (
  repoRoot: string,
  log: ToolingLog
) => Promise<EvalSuiteDefinition>;
export declare const promptForConnector: (
  repoRoot: string,
  log: ToolingLog,
  message?: string
) => Promise<string>;
export declare const promptForProject: (
  repoRoot: string,
  log: ToolingLog,
  message?: string
) => Promise<string[]>;
...
export declare const SCOUT_EVALS_ARGS: readonly [
  'start-server',
  '--arch',
  'stateful',
  '--domain',
