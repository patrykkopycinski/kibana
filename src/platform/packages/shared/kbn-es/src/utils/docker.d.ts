...
export declare const serverlessProjectTypes: readonly ['es', 'oblt', 'security', 'workplaceai', 'vectordb'];
export type ServerlessProjectType = (typeof serverlessProjectTypes)[number];
export declare const esServerlessProjectTypes: readonly ['elasticsearch', 'elasticsearch_general_purpose', 'elasticsearch_vector', 'observability', 'security', 'workplaceai', 'vectordb'];
export type EsServerlessProjectType = (typeof esServerlessProjectTypes)[number];
export declare const serverlessProductTiers: readonly ['essentials', 'logs_essentials', 'complete', 'search_ai_lake'];
...
export declare const ES_SERVERLESS_REPO_KIBANA = "docker.elastic.co/kibana-ci/elasticsearch-serverless";
export declare const ES_SERVERLESS_REPO_ELASTICSEARCH = "docker.elastic.co/elasticsearch-ci/elasticsearch-serverless";
export declare const ES_SERVERLESS_LATEST_VERIFIED_TAG = "latest-verified";
export declare const ES_SERVERLESS_DEFAULT_IMAGE = "docker.elastic.co/kibana-ci/elasticsearch-serverless:latest-verified";
export declare function getSharedServerlessParams(nameSuffix?: string): string[];
export declare function getServerlessNodes(nameSuffix?: string, portOffset?: number): Array<Omit<ServerlessEsNodeArgs, 'image'>>;
 ...
 */
export declare function resolveDockerImage({ tag, image, repo, defaultImg, }: {
    tag?: string;
    image?: string;
    repo: string;
    defaultImg: string;
 ...
 */
export declare function isDockerImageAvailableLocally(image: string): Promise<boolean>;
 ...
 */
export declare function resolveEsArgs(defaultEsArgs: Array<[string, string]>, options: ServerlessOptions | DockerOptions, projectIdOverride?: string): string[];
 ...
 */
export declare function setupServerlessVolumes(log: ToolingLog, options: ServerlessOptions, overrides?: {
    projectId?: string;
    operatorPath?: string;
}): Promise<string[]>;
/**
 ...
 */
export declare function runServerlessEsNode(log: ToolingLog, { params, name, image }: ServerlessEsNodeArgs, sharedParams?: string[]): Promise<void>;
/**
 * Runs an ES Serverless Cluster through Docker
 */
export declare function runServerlessCluster(log: ToolingLog, options: ServerlessOptions): Promise<string[]>;
 ...
 */
export declare function runLinkedServerlessCluster(log: ToolingLog, options: ServerlessOptions): Promise<string[]>;
/**
 ...
 */
export declare function teardownServerlessClusterSync(log: ToolingLog, options: ServerlessOptions): void;
/**
 ...
 */
export declare function runDockerContainer(log: ToolingLog, options: DockerOptions): Promise<string | void>;
