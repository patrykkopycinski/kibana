...
declare function mapOf<K, V>(
  keyType: Type<K>,
  valueType: Type<V>,
  options?: MapOfOptions<K, V>
): Type<Map<K, V>>;
declare function recordOf<K extends string, V>(
  keyType: Type<K>,
  valueType: Type<V>,
  options?: RecordOfOptions<K, V>
): Type<Record<K, V>>;
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K, L, M, N>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K, L, M>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K, L>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J, K>(
  types: [
    Type<A>,
    Type<B>,
    Type<C>,
...
declare function oneOf<A, B, C, D, E, F, G, H, I, J>(
...
declare function allOf<A extends Props, B extends Props, C extends Props, D extends Props>(
  types: [ObjectType<A>, ObjectType<B>, ObjectType<C>, ObjectType<D>],
  options?: UnionTypeOptions<A & B & C & D>
): Type<ObjectResultType<A & B & C & D>>;
declare function allOf<A extends Props, B extends Props, C extends Props>(
  types: [ObjectType<A>, ObjectType<B>, ObjectType<C>],
  options?: UnionTypeOptions<A & B & C>
): Type<ObjectResultType<A & B & C>>;
declare function allOf<A extends Props, B extends Props>(
  types: [ObjectType<A>, ObjectType<B>],
  options?: UnionTypeOptions<A & B>
): Type<ObjectResultType<A & B>>;
declare function allOf<A extends Props>(
  types: [ObjectType<A>],
