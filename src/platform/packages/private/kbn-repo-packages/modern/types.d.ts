...
export type KibanaPackageType = 'core' | 'plugin' | 'tooling' | 'shared-browser' | 'shared-server' | 'shared-common' | 'shared-scss' | 'functional-tests' | 'test-helper';
...
export type KibanaPackageManifest = PluginPackageManifest | SharedBrowserPackageManifest | BasePackageManifest;
