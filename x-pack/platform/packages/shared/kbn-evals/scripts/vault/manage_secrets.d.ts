...
declare const configSchema: import('@kbn/config-schema').ObjectType<{
  ...
  tracingEs: import('@kbn/config-schema').Type<
    | Readonly<
        {} & {
          url: string;
          apiKey: string;
    ...
    | undefined
  >;
  evaluationsKbn: import('@kbn/config-schema').Type<
    | Readonly<
        {} & {
          url: string;
          apiKey: string;
...
export declare const getCommand: (
  format: 'vault-write' | 'env-var' | undefined,
