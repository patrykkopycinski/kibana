 ...
 */
export declare const getAppMenuEbtDomProps: (ebt?: AppMenuEbtAttrs) =>
  | {
 ...
 */
export declare const getLinkProps: <E extends Element = Element>({
  href,
  onClick,
}: {
  href?: string;
 ...
 */
export declare const getDisplayedItemsAllowedAmount: (
 ...
 */
export declare const getShouldOverflow: ({
  config,
 ...
 */
export declare const getAppMenuItems: ({
  config,
  hasStaticItems,
}: {
  config?: AppMenuConfig;
...
export declare const hasNonGlobalStaticItems: (
  staticItems?: Array<{
    global?: boolean;
  }>
) => boolean;
...
export declare const createReturnFocus: (
  triggerElement: HTMLElement,
  parentElement?: HTMLElement
) => () => void;
export declare const mapAppMenuItemToPanelItem: (
 ...
 */
export declare const getPopoverActionItems: ({
  primaryActionItem,
 ...
 */
export declare const getPopoverSwitchItems: ({
  switchConfig,
}: {
 ...
 */
export declare const getPopoverPanels: ({
  items,
  staticItems,
  primaryActionItem,
  switchConfig,
 ...
 */
export declare const getIsSelectedColor: ({
  color,
  euiTheme,
  isFilled,
}: {
