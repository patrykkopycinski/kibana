 ...
 */
export declare function isExpressionComplete(
 ...
 */
export declare function getBinaryExpressionOperand(
 ...
 */
export declare function getAssignmentExpressionRoot(
  assignment: ESQLFunction
): ESQLSingleAstItem | undefined;
export declare function getPromqlExpressionType(
