import type { ApiServicesFixture, EsClient, KbnClient, KibanaUrl, ScoutLogger, ScoutSpaceParallelFixture, ScoutTestConfig } from '../../fixtures/scope/worker';
import type { BrowserAuthFixture, ScoutPage, PageObjects, NetworkFixture } from '../../fixtures/scope/test';
export declare const scoutParallelFixtures: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions & {
...
export declare const globalSetupFixtures: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions, import("playwright/test").PlaywrightWorkerArgs & import("playwright/test").PlaywrightWorkerOptions & import("../../fixtures/scope/worker/core_fixtures").BaseWorkerFixtures & {
    samlAuth: import("../..").SamlAuth;
} & {
 ...
 */
export declare const globalTeardownFixtures: import("playwright/test").TestType<import("playwright/test").PlaywrightTestArgs & import("playwright/test").PlaywrightTestOptions, import("playwright/test").PlaywrightWorkerArgs & import("playwright/test").PlaywrightWorkerOptions & import("../../fixtures/scope/worker/core_fixtures").BaseWorkerFixtures & {
    samlAuth: import("../..").SamlAuth;
} & {
    apiServices: ApiServicesFixture;
}>;
