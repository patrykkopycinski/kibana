 ...
 * @public
 */
export declare const validBodyOutput: readonly ['data', 'stream'];
/**
 ...
 * @public
 */
export type OASOperationObject = DeepPartial<OpenAPIV3.OperationObject & {
...
export type AllRequiredCondition = Array<Privilege | {
    anyOf: Privilege[];
}>;
export type AnyRequiredCondition = Array<Privilege | {
    allOf: Privilege[];
}>;
/**
 ...
 */
export declare enum ReservedPrivilegesSet {
    operator = "operator",
    superuser = "superuser"
}
/**
