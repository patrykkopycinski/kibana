...
export interface AlertingApiService {
    rules: {
        ...
        scheduleSnooze: (ruleId: string, params?: ScheduleSnoozeParams, spaceId?: string) => Promise<any>;
    ...
    connectors: {
        ...
        update: (connectorId: string, updates: Partial<CreateConnectorParams>, spaceId?: string) => Promise<any>;
    ...
    waiting: {
        waitForRuleStatus: (ruleId: string, expectedStatus: string, spaceId?: string, timeoutMs?: number) => Promise<string>;
        waitForAlertInIndex: (indexName: string, ruleId: string, timeoutMs?: number) => Promise<any>;
        waitForExecutionCount: (ruleId: string, count: number, spaceId?: string, timeoutMs?: number, dateStart?: Date) => Promise<void>;
        waitForNextExecution: (ruleId: string, spaceId?: string, timeoutMs?: number, dateStart?: Date) => Promise<void>;
    };
    cleanup: {
...
export declare const getAlertingApiHelper: (log: ScoutLogger, kbnClient: KbnClient) => AlertingApiService;
