...
export declare function generateCosmosDBApiRequestHeaders(httpVerb: 'POST' | 'PUT' | 'DELETE', resourceType: 'dbs' | 'colls' | 'docs', resourceId: string): {
 ...
 */
export declare function createUiamOAuthAccessToken({ username, organizationId, projectType: rawProjectType, roles, audience, fullName, email, accessTokenLifetimeSec, }: {
    username: string;
    organizationId: string;
    projectType: string;
    roles: string[];
