...
export declare const AppMenuHeaderLinks: ({
  children,
}: {
...
export declare const AppMenuResponsiveContent: ({
  content,
  breakpoint,
  source,
}: AppMenuResolvedResponsiveContentProps) => React.JSX.Element;
export declare const AppMenuApplicationResponsiveContent: (
  props: AppMenuResponsiveContentProps
) => React.JSX.Element;
export declare const AppMenuViewportResponsiveContent: (
  props: AppMenuResponsiveContentProps
) => React.JSX.Element;
export {};
