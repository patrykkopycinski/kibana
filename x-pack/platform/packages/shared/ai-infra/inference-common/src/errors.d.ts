...
>;
export declare function createInferenceInternalError(
  message?: string,
  meta?: Record<string, any>
): InferenceTaskInternalError;
export declare function createInferenceProviderError(
  message?: string,
  meta?: {
    status?: number;
  }
): InferenceTaskProviderError;
export declare function createInferenceRequestError(
  message: string,
  status: number
 ...
 */
export declare function isInferenceError(
  error: unknown
 ...
 */
export declare function isInferenceInternalError(
  error: unknown
): error is InferenceTaskInternalError;
/**
 ...
 */
export declare function isInferenceRequestAbortedError(
  error: unknown
): error is InferenceTaskAbortedError;
/**
 * Check if the given error is an {@link InferenceTaskProviderError}
 */
export declare function isInferenceProviderError(
  error: unknown
): error is InferenceTaskProviderError;
