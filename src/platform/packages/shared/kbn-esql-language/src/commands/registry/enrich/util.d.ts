...
export declare const buildPoliciesDefinitions: (
  policies: Array<{
    name: string;
    sourceIndices: string[];
  }>
) => ISuggestionItem[];
export declare const getPolicyMetadata: (
  policies: Map<string, ESQLPolicy>,
  policyName: string
) => ESQLPolicy | undefined;
...
export declare const buildMatchingFieldsDefinition: (
