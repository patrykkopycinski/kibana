...
export declare class DiscoverApp {
    ...
    selectDataView(name: string, { createAdHocIfMissing, waitForFieldList, }?: {
    ...
    editCurrentDataViewName(name: string, { withConfirmation }?: {
        withConfirmation?: boolean;
    }): Promise<void>;
    editDataViewFromSearchBar({ newIndexPattern, newTimeField, }: {
        newIndexPattern?: string;
        newTimeField?: string;
    }): Promise<void>;
    createRuntimeField({ fieldName, script, popularity, }: {
        fieldName: string;
        script: string;
        popularity?: number;
    }): Promise<void>;
     ...
     */
    setQueryMode(currentMode: DiscoverQueryMode, defaultMode?: DiscoverQueryMode): Promise<import("playwright-core").Disposable>;
    /**
