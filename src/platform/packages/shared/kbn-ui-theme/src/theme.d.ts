 ...
 */
export declare const darkMode: boolean;
/**
 ...
 */
export declare function getEuiThemeVars(theme: { name: string; darkMode: boolean }): {
  euiZDataGrid: number;
  ...
  euiColorBackgroundBaseInteractiveHoverAssistance: string;
