...
import type { AppId as AnalyticsApp, DeepLinkId as AnalyticsDeepLink } from '@kbn/deeplinks-analytics';
import type { AppId as MlApp, DeepLinkId as MlLink } from '@kbn/deeplinks-ml';
import type { AppId as ManagementApp, DeepLinkId as ManagementLink } from '@kbn/deeplinks-management';
import type { DeepLinkId as SearchLink, EnterpriseSearchAnalyticsApp, EnterpriseSearchApp, EnterpriseSearchApplicationsApp, EnterpriseSearchContentApp } from '@kbn/deeplinks-search';
import type { AppId as ObservabilityApp, DeepLinkId as ObservabilityLink } from '@kbn/deeplinks-observability';
...
/** @public */
export type AppId = DevToolsApp | AnalyticsApp | MlApp | ManagementApp | EnterpriseSearchApp | EnterpriseSearchContentApp | EnterpriseSearchApplicationsApp | EnterpriseSearchAnalyticsApp | ObservabilityApp | SecurityApp | FleetApp | SharedApp | WorkplaceAIApp | VectordbApp | WorkflowsApp;
/** @public */
export type AppDeepLinkId = AnalyticsDeepLink | DevToolsLink | MlLink | ManagementLink | SearchLink | ObservabilityLink | SecurityLink | FleetLink | SharedLink | WorkplaceAILink | VectordbLink | AgentBuilderLink | ContextEngineLink | WorkflowsLink;
/** @public */
export type CloudLinkId = 'userAndRoles' | 'performance' | 'billingAndSub' | 'deployment' | 'deployments' | 'projects';
...
interface ChromeNavigationNodeCommon extends Omit<NodeDefinitionCommon<AppDeepLinkId, string>, 'link' | 'cloudLink'> {
    id: string;
...
export type StandardNodeDefinition<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string, ChildrenId extends string = Id> = NodeDefinitionCommon<LinkId, Id> & {
    renderAs?: never;
    children?: Array<StandardNodeDefinition<LinkId, ChildrenId, ChildrenId> | (NodeDefinitionCommon<LinkId, Id> & {
        renderAs: 'panelOpener';
        children?: Array<StandardNodeDefinition<LinkId, ChildrenId>>;
    })>;
};
/** Allowed only under `panelOpener.children`. */
export type PanelOpenerChildDefinition<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string> = StandardNodeDefinition<LinkId, Id, Id>;
export type RootNodePanelOpenerDefinition<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string, ChildrenId extends string = Id> = NodeDefinitionCommon<LinkId, Id> & {
    renderAs: 'panelOpener';
    children?: Array<PanelOpenerChildDefinition<LinkId, ChildrenId>>;
};
/** Root-level node: body/footer items. */
export type RootNodeDefinition<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string, ChildrenId extends string = Id> = StandardNodeDefinition<LinkId, Id, ChildrenId> | (NodeDefinitionCommon<LinkId, Id> & {
    renderAs: 'home';
    children?: never;
 ...
 */
export type NodeDefinition<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string, ChildrenId extends string = Id> = RootNodeDefinition<LinkId, Id, ChildrenId>;
/**
 * @public
 *
 * Definition for the complete navigation tree, including body and footer
 */
export interface NavigationTreeDefinition<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string, ChildrenId extends string = Id> {
    /**
