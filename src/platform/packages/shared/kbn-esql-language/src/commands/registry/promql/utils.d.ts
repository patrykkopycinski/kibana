...
export declare const PROMQL_RANGE_PARAM_NAMES: readonly [
...
export declare function isParamValueComplete(
  fullQuery: string,
  cursorPosition: number,
  currentParam?: string
): boolean;
export declare function isAtValidColumnSuggestionPosition(
...
export declare function getIndexAssignmentContext(
  commandText: string
