...
import { getOr, set, omit } from 'lodash/fp';
...
const SearchBarComponent: React.FC<SiemSearchBarProps &
  SiemSearchBarRedux &
  SiemSearchBarDispatch> = ({
  end,
  filterQuery,
  fromStr,
  id,
...
SearchBarComponent.displayName = 'DupaSiemSearchBar';
...
export const SiemSearchBar = connect(
  ...
  memo(SearchBarComponent, (prevProps, nextProps) => {
    const { queries: prevQueries, ...restPrevProps } = prevProps;
    const { queries: nextQueries, ...restNextProps } = nextProps;
