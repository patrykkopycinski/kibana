...
export declare class DataGrid {
    ...
    getComparisonDiffSegments(rowIndex: number, colIndex: number): Promise<Array<{
    ...
    resizeColumnInDashboard(field: string, delta: number): Promise<{
        originalWidth: number;
        newWidth: number;
    }>;
    resizeColumnInDiscover(field: string, delta: number): Promise<{
        originalWidth: number;
        newWidth: number;
    }>;
    runInTableSearch(searchTerm: string): Promise<void>;
    setInTableSearchTerm(searchTerm: string): Promise<void>;
    selectRow(rowIndex: number, { pressShiftKey }?: {
