...
export declare class KbnClientUiSettings {
    ...
    constructor(log: ToolingLog, requester: KbnClientRequester, defaults?: UiSettingValues | undefined);
    get(setting: string, { space }?: {
        space?: string;
     ...
     * with some defaults
     */
    replace(doc: UiSettingValues, { retries, space }?: {
        retries?: number;
        space?: string;
    }): Promise<void>;
    /**
     ...
     */
    update(updates: UiSettingValues, { space }?: {
        space?: string;
    }): Promise<void>;
    /**
